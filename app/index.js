  ...
  writing() {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(this.appName, "README.md"),
      {
        ...
        description: `This ${
          this.controlSystem
        } readme document was created on ${new Date().toLocaleString()} using Yoeman ${
          pkg.name
        } v${pkg.version}`,
      }
    );
    ...
    if (this.controlSystem == "Crestron") {
      ...
      this.fs.copy(
        ...
        this.destinationPath(
          this.appName + "/Source Code/Crestron",
          this.appName + ".xadr"
        )
      );
    }
    ...
    folders.forEach((e) => {
      ...
      mkdirp(`${this.appName}/${e}/`).then(() => {
        fs.writeFileSync(
          `${this.appName}/${e}/README.md`,
